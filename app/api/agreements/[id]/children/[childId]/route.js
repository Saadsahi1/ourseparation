...
const FIELDS = ['full_name', 'birth_date', 'primary_residence']
...
export async function PUT(req, { params }) {
  try {
    ...
    const upd = buildUpdateSQL('children', FIELDS, body,
...
export async function DELETE(req, { params }) {
  try {
    ...
    await pool.query('DELETE FROM children WHERE id = $1 AND agreement_id = $2', [childId, id])
